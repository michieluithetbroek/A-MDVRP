...
class Laporte_single_customer: public Cut
{
  ...
  public:
    ...
    Laporte_single_customer (int priority, bool lazy, bool user, 
                             bool stopIfFound, bool onlyRootNode, Data const &data)
    : 
      Cut       (priority, lazy, user, stopIfFound, onlyRootNode, std::string("Lap (single)")),
